...
public interface JpaConst {
    ...
    //指定した日報にしたいいねを全件idの降順で取得する
    String Q_GOD_GET_REP = ENTITY_GOD + ".getReport";
    String Q_GOD_GET_REP_DEF = "SELECT g FROM Good AS g WHERE g.report = :" + JPQL_PARM_REPORT + " ORDER BY g.id DESC";
    //指定した日報にしたいいね件数を取得する
    String Q_GOD_COUNT_REP = ENTITY_GOD + ".count";
    String Q_GOD_COUNT_REP_DEF = "SELECT COUNT(g) FROM Good AS g WHERE g.report = :" + JPQL_PARM_REPORT;
